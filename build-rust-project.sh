...
do
    ...
    ./build/bin/llc $([ $shared -eq 1 ] && echo "-relocation-model=pic" || echo "-relocation-model=static") -o - | \
    ./build/bin/clang $([ $shared -eq 1 ] && echo "-fPIC" || echo "-fno-PIC") -c -x assembler - -o "$temp_obj"
